...
wget https://github.com/opencv/opencv/archive/3.4.16.zip -O opencv_source.zip
wget https://github.com/opencv/opencv_contrib/archive/3.4.16.zip -O opencv_contrib.zip
